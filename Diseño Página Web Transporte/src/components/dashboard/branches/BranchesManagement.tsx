...
const mapSummaryToBranch = (summary: any): Branch => ({
  ...
  address: summary.direccion || '',
  addressDetail: '',
  city: summary.ciudadNombre || '',
  neighborhood: summary.barrioNombre || '',
  cityNeighborhood: [summary.ciudadNombre, summary.barrioNombre].filter(Boolean).join(', '),
  latitude: undefined,
  longitude: undefined,
  accountNumber: '',
  accountType: '',
